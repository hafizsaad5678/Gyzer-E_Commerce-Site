      ...
      <div className="container-page py-16 grid gap-12 md:grid-cols-4">
        <div className="md:col-span-2 space-y-5">
          <div className="flex items-center gap-2.5">
            <span className="thermal-gradient grid h-9 w-9 place-items-center rounded-md text-primary-foreground font-display text-lg font-semibold">
              A
            </span>
          ...
          <form onSubmit={subscribe} className="flex max-w-md gap-2">
            ...
            <button
              disabled={loading}
              className="rounded-md bg-copper px-4 py-2 text-sm font-medium text-copper-foreground hover:opacity-90 disabled:opacity-60"
            >
              {loading ? "..." : "Subscribe"}
            </button>
          </form>
