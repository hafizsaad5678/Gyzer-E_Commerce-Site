...
export function SiteFooter() {
 ...
 return (
 <footer className="mt-24 border-t border-border bg-gradient-to-br from-[oklch(0.18_0.03_235)] to-[oklch(0.28_0.06_45)] text-sidebar-foreground">
 ...
 <button
 disabled={loading}
 className="rounded-md bg-secondary hover:bg-copper text-foreground hover:text-copper-foreground px-4 py-2 text-sm font-medium transition-colors disabled:opacity-60"
 >
 {loading ? "..." : "Subscribe"}
 </button>
 </form>
 ...
 <li>
 <Link to="/shop" className="hover:text-copper">
 All Products
 </Link>
 </li>
 <li>
 <Link to="/categories" className="hover:text-copper">
 Categories
 </Link>
 </li>
 <li>
 <Link to="/warranty" className="hover:text-copper">
 Warranty
 </Link>
 </li>
 <li>
 <Link to="/shipping" className="hover:text-copper">
 Shipping
 </Link>
 </li>
 <li>
 <Link to="/returns" className="hover:text-copper">
 Returns
 </Link>
 </li>
 </ul>
 ...
 <li>
 <Link to="/faq" className="hover:text-copper">
 FAQ
 </Link>
 </li>
 <li>
 ...
 <li>
 <Link to="/terms" className="hover:text-copper">
 Terms
 </Link>
 </li>
 </ul>
 ...
 <a href="#" aria-label="Facebook" className="hover:text-copper">
 <Facebook className="h-4 w-4" />
 </a>
 <a href="#" aria-label="Instagram" className="hover:text-copper">
 <Instagram className="h-4 w-4" />
 </a>
 <a href="#" aria-label="Youtube" className="hover:text-copper">
