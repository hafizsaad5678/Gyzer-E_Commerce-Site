...
export function PolicyPage({ title, subtitle, children }: { title: string; subtitle?: string; children: React.ReactNode }) {
  return (
    <SiteLayout>
      <article className="container-page py-12 md:py-20 max-w-3xl prose-policy">
        <div className="text-xs uppercase tracking-wider text-copper font-semibold mb-2">Policy</div>
