...
export function MessageThread({ message: m, onUpdated }: Props) {
 ...
 className="inline-flex items-center gap-1.5 text-xs rounded-md bg-copper text-white px-3 py-1.5 transition"
 >
 ...
 className="inline-flex items-center gap-1.5 rounded-md bg-secondary hover:bg-copper text-foreground hover:text-copper-foreground transition-colors px-4 py-2 text-sm font-medium disabled:opacity-50 transition"
 >
