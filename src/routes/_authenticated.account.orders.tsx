...
function Orders() {
 ...
 <Link
 to="/shop"
 className="inline-flex rounded-md bg-secondary hover:bg-copper text-foreground hover:text-copper-foreground transition-colors px-5 py-2.5 text-sm font-medium"
 >
 Start shopping
 </Link>
 </div>
