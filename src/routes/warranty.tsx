...
export const Route = createFileRoute("/warranty")({
 ...
 subtitle="What's covered, for how long, and how to claim."
 >
 <h2>Coverage period</h2>
 <p>
 Warranty periods vary by model: electric geysers (5 years), gas geysers (3–4 years), instant
 geysers (2 years), and solar systems (7 years). The exact period is printed on every product
 ...
 <h2>How to claim</h2>
 <p>
 Call our support line or open a ticket from your account dashboard. Have your order number
 ready. Most claims are resolved within 48 hours; in-warranty service is free.
 </p>
 </PolicyPage>
 ),
});
