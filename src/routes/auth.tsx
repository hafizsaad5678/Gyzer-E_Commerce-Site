      ...
      <section className="container-page py-16 md:py-24 grid lg:grid-cols-2 gap-12 items-center max-w-5xl">
        ...
        <div className="surface-card p-7 md:p-9">
          ...
          <form onSubmit={handle} className="space-y-4">
            ...
            <button
              disabled={loading}
              className="w-full inline-flex items-center justify-center gap-2 rounded-md bg-primary px-5 py-3 text-sm font-medium text-primary-foreground hover:opacity-90 disabled:opacity-60"
            >
              {loading
                ? "..."
                : mode === "signin"
